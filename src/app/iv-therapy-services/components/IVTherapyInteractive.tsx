        ...
        <div
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center py-20">
            ...
            <div>
              ...
              <h1
                ...
                style={{
                  ...
                  color: "var(--color-text)",
                  animation:
                  "animationIn 0.7s cubic-bezier(0.16,1,0.3,1) 0.2s both"
                }}>
              ...
              <p
                ...
                style={{
                  ...
                  fontFamily: "var(--font-body)",
                  animation:
                  "animationIn 0.7s cubic-bezier(0.16,1,0.3,1) 0.35s both",
                  maxWidth: "480px"
                }}>
              ...
              <div
                style={{
                  animation:
                  "animationIn 0.7s cubic-bezier(0.16,1,0.3,1) 0.5s both"
                }}>
            ...
            <div
              ...
              style={{
                animation:
                "animationIn 0.9s cubic-bezier(0.16,1,0.3,1) 0.4s both"
              }}>
              ...
              <div
                ...
                <p
                  ...
                  {t("lang") === "en" ?
                  "Patient satisfaction" : "Satisfacción de pacientes"}
                </p>
              </div>
...
}: {onClose: () => void;t: (key: string) => string; // eslint-disable-next-line @typescript-eslint/no-explicit-any
  tObj: (key: string) => any;}) {const { lang } = useTranslation();
