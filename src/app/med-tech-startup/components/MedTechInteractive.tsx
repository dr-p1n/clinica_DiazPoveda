    ...
    <>
      ...
      <section
        ...
        <div
          ...
          style={{
            backgroundImage:
            "radial-gradient(rgba(245,233,160,0.6) 1px, transparent 1px)",
        ...
        <div
          className="mx-auto px-6 w-full relative z-10"
          ...
          <div className="max-w-3xl py-24">
            ...
            <div
              ...
              style={{
                animation:
                "animationIn 0.8s cubic-bezier(0.16,1,0.3,1) 0.5s both"
              }}>
        ...
        <div
          ...
          <div
            ...
            style={{
              background:
              "linear-gradient(to bottom, rgba(245,233,160,0.5), transparent)"
            }} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div
              ...
              onMouseEnter={(e) => {
                ...
                "rgba(245,233,160,0.3)";
                (e.currentTarget as HTMLDivElement).style.background =
                "rgba(245,233,160,0.1)";
              }}
              onMouseLeave={(e) => {
                (e.currentTarget as HTMLDivElement).style.borderColor =
                "rgba(245,233,160,0.12)";
                (e.currentTarget as HTMLDivElement).style.background =
                "rgba(245,233,160,0.06)";
              }}>
                ...
                style={{ color: "rgba(255,253,245,0.55)" }}>
        ...
        <div
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <div
              ...
              <div
                ...
                <AppImage
                  ...
                  alt="Dr. Valentina Reyes, founder of NatalTech, smiling in a clinical coat in a modern medical office"
                  width={600}
                  height={460}
            ...
            <div
              ...
              style={{
                animation:
                "animationIn 0.8s cubic-bezier(0.16,1,0.3,1) 0.15s both"
              }}>
